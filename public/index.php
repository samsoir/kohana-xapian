...
$kohana_file = APPPATH.'classes/kohana'.EXT;

if (!is_file($kohana_file) && is_file(MODPATH.'search/classes/kohana'.EXT))
{
    $kohana_file = MODPATH.'search/classes/kohana'.EXT;
}
else
{
    $kohana_file = SYSPATH.'classes/kohana'.EXT;
}
